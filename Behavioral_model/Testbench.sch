...
C {code.sym} -410 20 0 0 {name=switch1 only_toplevel="false" value=".model switch1 sw vt=0.1 vh=0 ron=1m roff=100G"}
...
C {vsource.sym} 10 380 0 0 {name=V4 value=1.8 savecurrent=false}
C {gnd.sym} 290 -140 0 0 {name=l3 lab=GND}
C {gnd.sym} 10 430 0 0 {name=l4 lab=GND}
...
C {lab_pin.sym} 10 330 1 0 {name=p4 sig_type=std_logic lab=c1}
C {lab_pin.sym} -60 160 0 0 {name=p5 sig_type=std_logic lab=c1}
C {vsource.sym} 160 380 0 0 {name=V1 value="pulse(0 1.8 5u 0 0 5u 15u)" savecurrent=false}
C {gnd.sym} 160 430 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 160 330 1 0 {name=p6 sig_type=std_logic lab=c2}
C {lab_pin.sym} 90 160 0 0 {name=p7 sig_type=std_logic lab=c2}
C {vsource.sym} 320 380 0 0 {name=V2 value="pulse(0 1.8 10u 0 0 5u 15u)" savecurrent=false}
C {gnd.sym} 320 430 0 0 {name=l2 lab=GND}
C {lab_pin.sym} 320 330 1 0 {name=p8 sig_type=std_logic lab=c3}
