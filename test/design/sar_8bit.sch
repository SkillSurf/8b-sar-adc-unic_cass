...
C {/foss/designs/test/design/adc_comp.sym} 490 -70 0 0 {name=x1}
...
C {/foss/designs/test/design/capdac_p.sym} -330 -220 2 1 {name=x3}
C {/foss/designs/test/design/capdac_m.sym} -330 90 0 0 {name=x4}
C {/foss/designs/test/design/sar_digital.sym} -1030 -70 0 0 {name=x2}
