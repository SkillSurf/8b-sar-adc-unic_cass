...
C {gnd.sym} 280 -240 3 0 {name=l2 lab=GND}
C {gnd.sym} 410 -110 0 0 {name=l8 lab=GND}
C {capblock_256.sym} 260 -120 0 0 {name=x4}
C {lab_pin.sym} 410 -150 2 0 {name=p2 sig_type=std_logic lab=vdd}
C {gnd.sym} 410 -130 0 0 {name=l9 lab=GND}
C {lab_pin.sym} 110 -120 0 0 {name=p3 sig_type=std_logic lab=phi1[7..0]}
C {lab_pin.sym} 110 -100 0 0 {name=p7 sig_type=std_logic lab=phi1_n[7..0]}
C {lab_pin.sym} 110 -80 0 0 {name=p8 sig_type=std_logic lab=phi2[7..0]}
C {lab_pin.sym} 110 -60 0 0 {name=p11 sig_type=std_logic lab=phi2_n[7..0]}
C {capblock_256.sym} 260 340 2 0 {name=x5}
C {lab_pin.sym} 110 370 0 0 {name=p12 sig_type=std_logic lab=vdd}
C {gnd.sym} 110 350 1 0 {name=l12 lab=GND}
C {lab_pin.sym} 410 340 0 1 {name=p132 sig_type=std_logic lab=dn[7..0]}
C {lab_pin.sym} 410 300 0 1 {name=p133 sig_type=std_logic lab=d[7..0]}
C {lab_pin.sym} 410 320 0 1 {name=p93 sig_type=std_logic lab=dn_n[7..0]}
C {lab_pin.sym} 410 280 0 1 {name=p94 sig_type=std_logic lab=d_n[7..0]}
C {lab_pin.sym} 110 -200 0 0 {name=p35 sig_type=std_logic lab=smpl}
C {lab_pin.sym} 110 -160 0 0 {name=p36 sig_type=std_logic lab=smpl_n_d12}
C {lab_pin.sym} 110 -180 0 0 {name=p127 sig_type=std_logic lab=smpl_out_n}
C {lab_pin.sym} 110 -140 0 0 {name=p131 sig_type=std_logic lab=smpl_n_d12_out_n}
C {gnd.sym} 110 330 1 0 {name=l1 lab=GND}
C {gnd.sym} 240 460 0 0 {name=l13 lab=GND}
C {lab_pin.sym} 410 420 2 0 {name=p15 sig_type=std_logic lab=vdd}
C {gnd.sym} 410 400 3 0 {name=l14 lab=GND}
C {lab_pin.sym} 410 360 2 0 {name=p16 sig_type=std_logic lab=vdd}
C {gnd.sym} 410 380 3 0 {name=l15 lab=GND}
C {lab_pin.sym} -560 -110 0 0 {name=p82 sig_type=std_logic lab=smpl}
C {lab_pin.sym} -450 -140 1 0 {name=p85 sig_type=std_logic lab=vcm}
C {gnd.sym} -420 -50 3 0 {name=l58 lab=GND
value=0.6}
C {final/tg_final.sym} -410 130 0 0 {name=x2[10..0]}
C {lab_pin.sym} -560 -90 0 0 {name=p19 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -420 -70 2 0 {name=p20 sig_type=std_logic lab=smpl_out_n}
C {lab_pin.sym} -610 90 0 0 {name=p23 sig_type=std_logic lab=smpl}
C {lab_pin.sym} -500 60 1 0 {name=p24 sig_type=std_logic lab=vcm}
C {gnd.sym} -470 150 3 0 {name=l16 lab=GND
value=0.6}
C {final/tg_final.sym} -460 330 0 0 {name=x18[10..0]}
C {lab_pin.sym} -610 110 0 0 {name=p26 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -470 130 2 0 {name=p27 sig_type=std_logic lab=smpl_out_n}
C {lab_pin.sym} -340 -340 0 0 {name=p90 sig_type=std_logic lab=vinp}
C {lab_pin.sym} -370 -290 0 0 {name=p28 sig_type=std_logic lab=smpl}
C {gnd.sym} -230 -230 3 0 {name=l17 lab=GND
value=0.6}
C {final/tg_final.sym} -220 -50 0 0 {name=x5[10..0]}
C {lab_pin.sym} -370 -270 0 0 {name=p30 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -230 -250 2 0 {name=p31 sig_type=std_logic lab=smpl_out_n}
C {lab_pin.sym} -320 250 0 0 {name=p32 sig_type=std_logic lab=vinm}
C {lab_pin.sym} -350 300 0 0 {name=p33 sig_type=std_logic lab=smpl}
C {gnd.sym} -210 360 3 0 {name=l20 lab=GND
value=0.6}
C {final/tg_final.sym} -200 540 0 0 {name=x8[10..0]}
C {lab_pin.sym} -350 320 0 0 {name=p37 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -210 340 2 0 {name=p38 sig_type=std_logic lab=smpl_out_n}
C {lab_pin.sym} -280 -510 1 0 {name=p76 sig_type=std_logic lab=smpl_n_d12}
C {lab_pin.sym} -170 -540 0 0 {name=p87 sig_type=std_logic lab=vref}
C {gnd.sym} -140 -450 3 0 {name=l21 lab=GND
value=0.6}
C {final/tg_final.sym} -130 -270 0 0 {name=x9[10..0]}
C {lab_pin.sym} -280 -490 0 0 {name=p81 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -140 -470 2 0 {name=p78 sig_type=std_logic lab=smpl_n_d12_out_n}
C {lab_pin.sym} -450 500 1 0 {name=p39 sig_type=std_logic lab=smpl_n_d12}
C {lab_pin.sym} -340 470 0 0 {name=p40 sig_type=std_logic lab=vref}
C {gnd.sym} -310 560 3 0 {name=l22 lab=GND
value=0.6}
C {final/tg_final.sym} -300 740 0 0 {name=x10[10..0]}
C {lab_pin.sym} -450 520 0 0 {name=p41 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -310 540 2 0 {name=p42 sig_type=std_logic lab=smpl_n_d12_out_n}
