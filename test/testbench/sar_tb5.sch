...
C {devices/vsource.sym} -30 -1610 0 0 {name=V_VCM_1 value=vdiff}
C {devices/vsource.sym} 90 -1610 2 1 {name=V_VCM_3 value=vdiff}
...
value=0}
C {/foss/designs/test/design/sar_8bit.sym} 160 -1220 0 0 {name=x1}
