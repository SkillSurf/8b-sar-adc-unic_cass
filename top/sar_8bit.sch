...
C {lab_pin.sym} -480 -220 0 0 {name=p8 sig_type=std_logic lab=vrefp}
C {lab_pin.sym} -480 110 0 0 {name=p11 sig_type=std_logic lab=vrefm}
...
C {ipin.sym} -1550 -70 2 1 {name=p89 lab=vrefp
}
...
C {ipin.sym} -1560 -10 2 1 {name=p50 lab=vrefm
}
C {lab_pin.sym} -900 300 2 0 {name=p65 sig_type=std_logic lab=dvss}
C {lab_pin.sym} -1100 300 2 0 {name=p72 sig_type=std_logic lab=dvss}
