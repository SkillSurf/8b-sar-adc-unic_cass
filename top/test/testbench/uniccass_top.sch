...
value=0}
C {sar_8bit.sym} -340 -190 0 0 {name=x1}
C {lab_pin.sym} -460 170 0 0 {name=p2 sig_type=std_logic lab=vinp}
C {lab_pin.sym} -460 250 0 0 {name=p3 sig_type=std_logic lab=vinm}
C {lab_pin.sym} -500 210 0 0 {name=p5 sig_type=std_logic lab=vcm}
C {lab_pin.sym} -430 280 0 0 {name=p6 sig_type=std_logic lab=vref}
C {lab_pin.sym} -430 140 0 0 {name=p7 sig_type=std_logic lab=vref}
C {lab_pin.sym} -360 90 1 0 {name=p8 sig_type=std_logic lab=clk}
C {lab_pin.sym} -340 90 1 0 {name=p9 sig_type=std_logic lab=rst_n}
C {lab_pin.sym} -240 90 1 0 {name=p10 sig_type=std_logic lab=avdd}
C {lab_pin.sym} -220 90 1 0 {name=p11 sig_type=std_logic lab=avss}
C {lab_pin.sym} -200 90 1 0 {name=p12 sig_type=std_logic lab=dvdd}
C {lab_pin.sym} -180 90 1 0 {name=p13 sig_type=std_logic lab=dvss}
C {lab_pin.sym} -260 90 1 0 {name=p14 sig_type=std_logic lab=ibsnk_1u}
C {lab_pin.sym} -140 190 2 0 {name=p15 sig_type=std_logic lab=data_rdy}
C {lab_pin.sym} -140 210 2 0 {name=p16 sig_type=std_logic lab=dout[7..0]}
C {lab_pin.sym} -140 230 2 0 {name=p17 sig_type=std_logic lab=comp_out}
