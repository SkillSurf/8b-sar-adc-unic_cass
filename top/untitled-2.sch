...
C {devices/parax_cap.sym} -90 50 0 0 {name=C3 gnd=0 value=3f m=1}
C {devices/parax_cap.sym} 140 0 0 0 {name=C4 gnd=0 value=3f m=1}
C {devices/parax_cap.sym} -100 -40 0 0 {name=C5 gnd=0 value=3f m=1}
C {devices/parax_cap.sym} -100 0 0 0 {name=C1 gnd=0 value=3f m=1}
