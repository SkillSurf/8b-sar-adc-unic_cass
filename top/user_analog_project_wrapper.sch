...
C {/foss/designs/uniccass_top.sym} 3890 -180 0 0 {name=x3}
C {lab_pin.sym} 4040 -240 2 0 {name=p33 sig_type=std_logic lab=io_out[25]}
C {lab_pin.sym} 4040 -280 2 0 {name=p34 sig_type=std_logic lab=io_out[24]}
C {lab_pin.sym} 4040 -260 2 0 {name=p35 sig_type=std_logic lab=io_out[16:23]}
C {lab_pin.sym} 4040 -300 2 0 {name=p36 sig_type=std_logic lab=vdda2}
C {lab_pin.sym} 4040 -360 2 0 {name=p37 sig_type=std_logic lab=vssd2}
C {lab_pin.sym} 4040 -320 2 0 {name=p38 sig_type=std_logic lab=vssa2}
C {lab_pin.sym} 4040 -340 2 0 {name=p39 sig_type=std_logic lab=vccd2}
C {lab_pin.sym} 3740 -360 0 0 {name=p40 sig_type=std_logic lab=io_in[15]}
C {lab_pin.sym} 3740 -320 0 0 {name=p41 sig_type=std_logic lab=io_in[14]}
C {lab_pin.sym} 3740 -340 0 0 {name=p42 sig_type=std_logic lab=io_analog[10]}
C {lab_pin.sym} 3740 -300 0 0 {name=p43 sig_type=std_logic lab=io_analog[9]}
C {lab_pin.sym} 3740 -280 0 0 {name=p44 sig_type=std_logic lab=io_analog[8]}
C {lab_pin.sym} 3740 -260 0 0 {name=p46 sig_type=std_logic lab=io_analog[7]}
C {lab_pin.sym} 3740 -240 0 0 {name=p47 sig_type=std_logic lab=io_analog[6]}
C {lab_pin.sym} 3740 -220 0 0 {name=p45 sig_type=std_logic lab=io_analog[5]}
C {lab_pin.sym} 3740 -120 0 0 {name=p48 sig_type=std_logic lab=io_analog[4]}
C {lab_pin.sym} 3740 -60 0 0 {name=p49 sig_type=std_logic lab=io_analog[3]}
C {lab_pin.sym} 3740 -40 0 0 {name=p50 sig_type=std_logic lab=io_analog[2]}
C {lab_pin.sym} 3740 0 0 0 {name=p51 sig_type=std_logic lab=vssa1}
C {lab_pin.sym} 3740 -180 0 0 {name=p52 sig_type=std_logic lab=io_analog[1]}
C {lab_pin.sym} 3740 -20 0 0 {name=p53 sig_type=std_logic lab=io_analog[0]}
C {lab_pin.sym} 3740 -140 0 0 {name=p54 sig_type=std_logic lab=vccd1}
C {lab_pin.sym} 4040 -160 2 0 {name=p55 sig_type=std_logic lab=io_out[13]}
C {lab_pin.sym} 3740 -160 0 0 {name=p56 sig_type=std_logic lab=vdda1}
C {lab_pin.sym} 4040 -180 2 0 {name=p57 sig_type=std_logic lab=io_out[12:3]}
C {lab_pin.sym} 3740 -80 0 0 {name=p58 sig_type=std_logic lab=io_in[2]}
C {lab_pin.sym} 3740 20 0 0 {name=p59 sig_type=std_logic lab=vssd1}
